...
public:
  ...
  */
  void step(const InputsType& e, OutputsType& uk/*, const float dt*/)
  {
    ...
    const float ek = e.at(1)/*w*/ - e.at(0)/*y*/; //Control deviation
    ...
    else if (ukStorage <= -1.0F) /*limit controll signal to -1*/
    {
      uk.at(0) = -1.0F;
      hold = 1;
    }
